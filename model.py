...
class AnomalyAE(nn.Module):
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv2d(1, channels, (11, 11), stride=(1, 1), padding=5)
        self.bn1 = nn.BatchNorm2d(channels)

        self.conv2 = nn.Conv2d(channels, channels, (9, 9), stride=(2, 2), padding=4)
        self.bn2 = nn.BatchNorm2d(channels)

        self.conv3 = nn.Conv2d(channels, channels, (7, 7), stride=(2, 2), padding=3)
        self.bn3 = nn.BatchNorm2d(channels)

        self.conv4 = nn.Conv2d(channels, channels, (5, 5), stride=(2, 2), padding=2)
        self.bn4 = nn.BatchNorm2d(channels)

        self.conv5 = nn.Conv2d(channels, channels, (3, 3), stride=(2, 2), padding=1)
        self.bn5 = nn.BatchNorm2d(channels)

        self.conv_tr1 = nn.ConvTranspose2d(
            channels, channels, (5, 5), stride=(2, 2), padding=2, output_padding=1)
        self.bn_tr1 = nn.BatchNorm2d(channels)

        self.conv_tr2 = nn.ConvTranspose2d(
            channels*2, channels, (7, 7), stride=(2, 2), padding=3, output_padding=1)
        self.bn_tr2 = nn.BatchNorm2d(channels)

        self.conv_tr3 = nn.ConvTranspose2d(
            channels*2, channels, (9, 9), stride=(2, 2), padding=4, output_padding=1)
        self.bn_tr3 = nn.BatchNorm2d(channels)

        self.conv_tr4 = nn.ConvTranspose2d(
            channels*2, channels, (11, 11), stride=(2, 2), padding=5, output_padding=1)
        self.bn_tr4 = nn.BatchNorm2d(channels)

        self.conv_output = nn.Conv2d(channels*2, 1, (1, 1), (1, 1))
